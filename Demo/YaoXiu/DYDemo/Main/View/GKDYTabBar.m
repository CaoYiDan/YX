...
- (UIButton *)publishBtn {
    if (!_publishBtn) {
        ...
        [_publishBtn setImage:[UIImage imageNamed:@"zjbtn"] forState:UIControlStateNormal];
...
-(void)publishClick{
    ...
    if ([self.myDelegate respondsToSelector:@selector(tabBarMiddleClickDelegate)]) {
        [self.myDelegate tabBarMiddleClickDelegate];
    }
}
@end
