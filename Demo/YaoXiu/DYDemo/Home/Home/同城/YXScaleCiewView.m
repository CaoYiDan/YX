...
#import "YXScaleCiewView.h"
#import "GKDYVideoView.h"
#import "YXCommonCityCell.h"
#import "YXCommonCityVC.h"
#import "YXHomeVC.h"
@interface YXScaleCiewView()

@property (nonatomic, weak) YXHomeVC  *vc;

@property (nonatomic, assign) BOOL                      interacting;

@end

@implementation YXScaleCiewView

- (instancetype)initWithVC:(YXCommonCityVC *)vc videos:(NSArray *)videos index:(NSInteger)index {
    if (self = [super init]) {
...
- (void)show {
    ...
    // 获取当前显示的列表控制器
    YXCommonCityVC *listVC = self.vc.currentListVC;
    
    // 获取当前点击的cell
    YXCommonCityCell *cell = (YXCommonCityCell *)[listVC.collectionView cellForItemAtIndexPath:[NSIndexPath indexPathForItem:listVC.selectedIndex inSection:0]];
