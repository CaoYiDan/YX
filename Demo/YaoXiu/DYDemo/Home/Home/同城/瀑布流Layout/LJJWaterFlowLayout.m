...
#define kInterItemSpacing 1.0f //item间距
#define kLineSpacing 1.0f //行间距
...
- (void)layoutEachItemFrameAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CGFloat itemWidth = (kScreenWidth - (kColumnCount - 1)*kInterItemSpacing-edgeInsets.left-edgeInsets.right) / 2;
