...
- (void)addChildViewControllers{
    ...
    @[@{@"vc":[UIViewController new],@"normalImg":@"icon_tabbar_home_no",@"selectImg":@"icon_tabbar_home",@"itemTitle":@"首页"},
      @{@"vc":[UIViewController new],@"normalImg":@"icon_tabbar_subscription_no",@"selectImg":@"icon_tabbar_subscription",@"itemTitle":@"门店"},
      @{@"vc":[UIViewController new],@"normalImg":@"",@"selectImg":@"",@"itemTitle":@" "},
      @{@"vc":[UIViewController new],@"normalImg":@"icon_tabbar_notification_no",@"selectImg":@"icon_tabbar_notification",@"itemTitle":@"说说"},
    ...
    [VCArray enumerateObjectsUsingBlock:^(NSDictionary * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        model.normalColor = RGB(200, 197, 195);
//        model.normalTintColor = [UIColor blueColor];
//        model.selectBackgroundColor = [UIColor colorWithWhite:1 alpha:0.7];
        ...
        if (idx == 2 ) { // 如果是中间的
            ...
            model.normalImageName = model.selectImageName = @"zjbtn";
...
//    }];
    ...
    self.axcTabBar.backgroundColor = mainColor;
    // 8.添加覆盖到上边
