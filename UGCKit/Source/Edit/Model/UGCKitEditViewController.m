...
- (void)viewDidLoad {
    ...
    // 配置底部菜单
    UGCKitEditBottomMenu *menu = [[UGCKitEditBottomMenu alloc] initWithFrame:CGRectMake(0, self.view.ugckit_height - 62  - offset-12, self.view.ugckit_width, 62)
                                                               items:nil];
...
//    menu.backgroundColor = _theme.editPanelBackgroundColor;
    ...
    CGFloat btnConfirmWidth = 40;
    CGFloat btnConfirmHeight = 40;
